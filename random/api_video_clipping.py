...
def main():
    ...
    def process(path_to_video,
        ...
        try:
            ...
            job_status.set_status(
                dict(error_msg=msg,
                     parameter=dict(path_to_video=path_to_video,
    ...
    def audio_clip_endpoint():
        ...
        thread = Thread(target=process, args=[file_path, output_path, min_interval_sec, min_amplitude])
        thread.start()
